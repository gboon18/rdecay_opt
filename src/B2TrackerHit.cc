...
void B2TrackerHit::Print()
{
  ...
  //moved from B2TrackerSD.cc 20170612
    //moved to EventAction.cc 20170613
    /*
    G4int id = 27;
  G4AnalysisManager* analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillNtupleDColumn(id,0,fEdep);
  analysisManager->FillNtupleDColumn(id,1,fPos.x());
  analysisManager->FillNtupleDColumn(id,2,fPos.y());
  analysisManager->FillNtupleDColumn(id,3,fPos.z());
  analysisManager->FillNtupleDColumn(id,4,fTrackID);
  analysisManager->FillNtupleDColumn(id,5,fChamberNb);  
