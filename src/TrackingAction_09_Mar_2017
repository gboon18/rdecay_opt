...
//20170206///////////////////////////////
//#include "G4RichTrajectory.hh"//for trajectory visuallization
/////////////////////////////////////////
...
void TrackingAction::PreUserTrackingAction(const G4Track* track)
{
  ...
  //20170309 turned of due to /gps/source/multiplevertex true/////////////
  /*
  //Radioactive decay products
  G4int processType = track->GetCreatorProcess()->GetProcessSubType();
//20170309 this 'GetProcessSubType()' is the reason this "Radioactive decay products" part is turned of.
//this 'GetProcessSubType()' part does not go along with /gps/source/multiplevertex true. 
//It is not becuase I make gamma rays(no decay products....actually, it can make e-e+ pairs). 
//It also does not go along with ions...
  ...
  */
      /*
      //20170202 //////////////////////
    analysisManager->FillNtupleDColumn(id,4, double(Z));
    analysisManager->FillNtupleDColumn(id,5, double(A));
    //////////////////////////
    */
      /*
    analysisManager->AddNtupleRow(id);
  ...
  */
  ...
  //20170206/////////////////////////////////////////////////////
  fpTrackingManager->SetStoreTrajectory(true);//for trajectoryContainer in EventAction.cc this has to be turned on "true" for the trajectoryContainer to be functional.
  //  fpTrackingManager->SetTrajectory(new G4RichTrajectory(track));//WTF is G4RichTrajectory???? For coloring the trajectories?? 
 ////////////////////////////////////////////////////////////////
