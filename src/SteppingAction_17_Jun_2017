...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  fEventAction->AddEdep(iVol, edepStep, time, weight);/*G4cout<<"iVol : "<<iVol<<G4endl;*/
 ...
 analysisManager->FillNtupleDColumn(id,15, edepStep);
 analysisManager->AddNtupleRow(id);
...
OA  */
  ...
  //20170223/////////////////////////////////////////////////////////////////////////////////////////////////////
  //////////////////////////////////////////
  G4int i = 0;//CopyNo : total 16 of detectors 0 to 15
  G4int totCryst = 16;
  G4int Vol = 0;
  for(i = 0 ; i < totCryst ; i++){
    if ((volume1->GetName()=="s_crystal")&&(CopyNo==i)) Vol = i + 1;//20160225 :  default is the Vol = 0, must start from Vol = 1 to 16.
  }
  fEventAction->AddEdep2(Vol, edepStep, time, weight);
  //////////////////////////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
  //////////////////////////////////////////
